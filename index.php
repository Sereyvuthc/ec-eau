...
<html lang="en">
  ...
  <?php include "topbar.php" ?>
    ...
    <div class="hero-wrap" style="background-image: url('images/water-index-wallpaper.jpg'); background-attachment:fixed;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-10 ftco-animate text-center">
            <h1 class="mb-4">La solution écologique et économique</h1>
            <p>Grâce à notre test, vous allez pouvoir faire des économies tout en faisant un geste pour la planète !</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-10 text-center heading-section heading-section-white ftco-animate">
            <h2 class="title">Un projet innovant pour une planète plus verte</h2>
            <p class="description">
              Nous vous proposons de réaliser un test qui a pour objectif de vous donner des conseils afin d'optimiser
              votre consommation d'eau et donc de faire également des économies. Nous collectons également vos réponses
              afin d'en faire des statistiques afin de mieux comprendre les habitudes des utilisateurs et de proposer
              de meilleurs solutions générales et de meilleurs conseils.
            </p>
          </div>
        </div>
      </div>
    ...
    <!-- <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-6 col-lg-4 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/vincent.jpg);">
	                <div class="box">
	                  <h2>Vincent Schuck</h2>
	                </div>
	              </div>
	              <div class="back">
	                <blockquote>
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/vincent.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Vincent Schuck <span class="position">Neurologist</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
	        ...
	        <div class="col-md-6 col-lg-4 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/hugo.jpg);">
	                <div class="box">
	                  <h2>Hugo Gomez</h2>
	                </div>
	              </div>
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/hugo.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Hugo Gomez <span class="position">Pediatrician</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
	        ...
	        <div class="col-md-6 col-lg-4 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/serchu.jpg);">
	                <div class="box">
	                  <h2>Sereyvuth Chum</h2>
	                </div>
	              </div>
	              <div class="back">
	                <blockquote>
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/serchu.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Sereyvuth Chum <span class="position">Ophthalmologist</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/lyes.jpg);">
	                <div class="box">
	                  <h2>Lyes Bouali</h2>
	                </div>
	              </div>
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(images/lyes.jpg);"></div>
	                  </div>
	                  <div class="name align-self-center">Lyes Bouali <span class="position">Pulmonologist</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
        ...
        <div class="row">
        	<div class="col-md-9 ftco-animate">
        		<h4>Nous sommes déterminé</h4>
        		<p>
              Notre objectif est de donner à chacun des solutions pour contribuer pour le bien environnement,
              mais nous nous appliquons également à récolter des données afin de mieux comprendre la consommation des
              utilisateurs.
            </p>
        	</div>
        </div>
